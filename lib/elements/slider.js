...
export default class Slider extends Component {
  ...
  rangeMouseDown(isTouch, e) {
    ...
    if (!this.props.disabled) {
      ...
      if (this.props.settings.onChangeStart) {
        this.props.settings.onChangeStart();
      }
    }
  }
  ...
  rangeMouseUp() {
    if (this.state.mouseDown && this.props.settings.onChangeEnd) {
      this.props.settings.onChangeEnd();
    }
